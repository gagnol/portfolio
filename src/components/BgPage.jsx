  ...
  return (
    <>
      ...
      <svg
        ...
        style={{ opacity: 0.6, pointerEvents: 'none', position: 'absolute', top: 0, left: 0, width: '100%', height: '100%' }}
      >
        <g>
