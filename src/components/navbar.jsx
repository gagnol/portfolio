...
const Navbar = ({ accentColor, setAccentColor }) => {
  ...
  return (
    <div className="h-full flex items-center overflow-x-hidden
     justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      {/* LINKS */}
      ...
      {/* SOCIAL */}
      <div className="hidden md:flex float-right gap-4 w-1/3">
   
        <Link href="https://www.instagram.com/jsxplanet/">
          <Image src="/instagram.png" alt="" width={24} height={24} />
        </Link>
             
        <Link href="https://www.linkedin.com/in/guilleagnoletti">
          <Image src="/linkedin.png" alt="" width={24} height={24} />
        </Link>
        <DropdownMenu.Root>
              <DropdownMenu.Trigger>
                <Button variant="classic" size="3" mx="5">
                  Colors
